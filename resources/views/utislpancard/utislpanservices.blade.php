...
@section('content')
    <div class="container-fluid">
        <h5 class="card-title">PAN SERVICES</h5>
        <div class="card">
            <div class="card-body">
                <div class="row g-4">
                        ...
                        <div class="card mb-0">
                            <div class="card-body bg-white">
                                <div class="position-relative">
                                    <img src="/upload/service/{{ $s->service_image }}" class="img-fluid rounded"
                                    style="width: 200px; height: 150px;" alt="">
                                </div>
                                <div class="text-center mt-1 pt-1">
                                    <p class="mb-0 text-success"><b>{{ $s->service_name }}</b></p>
                                    <hr class="text-black">
                                    {{-- <h6 class="mb-2 text-danger">Amount: {{ $s->payment }}</h6> --}}
                                </div>
                                <div class="d-flex align-items-center justify-content-between">
                                    <a href="{{ url('/applyservices',$s->id) }}" class="btn btn-light">Apply</a>
                                    <a href="{{ url('/applyservices',$s->id) }}" class="btn btn-primary">List</a>
                                </div>
                            </div>
                        </div>
                    </div>
