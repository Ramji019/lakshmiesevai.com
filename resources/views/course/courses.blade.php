                                ...
                                <div class="card mb-0">
                                    <div class="card-body bg-white">
                                        <div class="position-relative">
                                            <img src="/upload/course_image/{{ $s->ser_image }}" class="img-fluid rounded"
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <a href="{{ url('/applycourseservice',$s->id) }}" class="btn btn-light">Apply</a>
                                            <a href="{{ url('/applycourseservice',$s->id) }}" class="btn btn-primary">List</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
