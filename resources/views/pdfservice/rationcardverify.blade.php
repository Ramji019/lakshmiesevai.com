            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form onsubmit="return checkpayment(event)" action="{{ url('/submitrationfind') }}"
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="aadhaar_no" maxlength="12" required
                                        autofocus placeholder="Aadhaar Number" />
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach ($rationdetails as $key => $ser)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            ...
                                            @else
                                            <td><a href="{{ url('/') }}/upload/smartpdf/{{ $ser->pdf }}" download class="btn btn-primary btn-sm">Download</a></td>
                                            @endif
                                            <td>{{ $ser->date }}</td>
                                        </tr>
                                    @endforeach
