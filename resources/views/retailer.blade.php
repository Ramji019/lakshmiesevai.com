        ...
        <div class="row g-3">
          <div class="col-auto">
            <div class="position-relative">
              <input class="form-control px-5" type="search" placeholder="Search Retailer">
          ...
          <div class="col-auto">
            <div class="d-flex align-items-center gap-2 justify-content-lg-end">
               ...
               <a href="{{ url('addcustomer') }}" class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Retailer</a>
            </div>
          </div>
        </div><!--end row-->
