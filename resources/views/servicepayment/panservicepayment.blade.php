        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="card-title">Panservice Payment</h5>
                    <form class="row g-4" action="{{ url('/addpan_payment') }}" enctype="multipart/form-data"
                        method="post">
                        {{ csrf_field() }}
                                    ...
                                    <tbody>
                                        @foreach ($services as $key => $ser)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                <td>{{ $ser->name }}</td>
                                                <td><input class="form-control decimal" value="{{ $ser->amount }}"
                                                        readonly /></td>
