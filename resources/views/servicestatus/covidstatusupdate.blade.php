                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/covid_update') }}" id="formAccountSettings" method="POST"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input @if (Auth::user()->id != $apply_user_id ) disabled @endif required type="text" maxlength="12" class="form-control" value="{{ $services->aadhaar_no }}"
                                name="aadhaar_no" placeholder="Aadhaar Number"/>
                                <label for="passport_no" class="form-label">Passport Number</label>
                            <input @if (Auth::user()->id != $apply_user_id ) disabled @endif required type="text" maxlength="15" class="form-control" value="{{ $services->passport_no }}"
