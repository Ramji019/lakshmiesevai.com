                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="{{ url('/driving_license_update') }}" id="formAccountSettings" method="POST"
                            ...
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="15" class="form-control" value="{{ $services->driving_license_no }}"
                            name="driving_license_no" placeholder="Driving License Number"/>
                            <label for="dob" class="form-label">DOB</label>
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="date" maxlength="10" class="form-control" value="{{ $services->dob }}"
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="id_proof" class="form-label">ID Proof</label>
                                    <select @if (Auth::user()->id != $apply_user_id) disabled @endif required
                                        name="id_proof" id="id_proof" class="form-control">
                                        <option value="">Select ID Proof</option>
                                        <option @if ($services->id_proof == 'License') selected @endif value="License">License</option>
                                        <option @if ($services->id_proof == 'Aadhaar Card') selected @endif value="Aadhaar Card">Aadhaar Card(Front&Back)</option>
                            ...
                            @else
                                <label>License</label>
                                <input @if ($services->driving_license == '') required @endif class="form-control"
                        ...
                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="15" class="form-control" value="{{ $services->rc_number }}"
