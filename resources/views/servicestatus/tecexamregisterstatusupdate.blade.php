                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/submit_statusupdate_tecexamregister') }}" id="formAccountSettings"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text"
                                            value="{{ $services->applicant_name }}" class="form-control"
                                            name="applicant_name" maxlength="30" placeholder="Applicant Name" />
                                        ...
                                        <select required @if (Auth::user()->id != $apply_user_id) disabled @endif class="form-control"
                                            name="gender">
                                            <option value="">Select</option>
                                            <option @if ($services->gender == 'Male') selected @endif value="Male">Male
                                            </option>
                                            <option @if ($services->gender == 'Female') selected @endif value="Female">Female
                                            </option>
                                        </select>

                                        <label for="district" class="form-label number">District</label>
                                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text"
                                            maxlength="15" class="form-control" value="{{ $services->district }}"
                                            name="district" placeholder="District" />

                                        <label for="address" class="form-label number">Address</label>
                                        <textarea @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="200" class="form-control"
                                            value="{{ $services->address }}" name="address" placeholder="Address">{{ $services->address }}</textarea>
                                    </div>
                                    <div class="mb-3 col-md-6">

                                        <label for="father_name" class="form-label">Father/Mother/Spouse Name</label>
                                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text"
                                            value="{{ $services->father_name }}" class="form-control" name="father_name"
                                            maxlength="30" placeholder="Father/Mother/Spouse Name" />

                                        <label for="email" class="form-label">Email</label>
                                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text"
                                            value="{{ $services->email }}" class="form-control" name="email"
