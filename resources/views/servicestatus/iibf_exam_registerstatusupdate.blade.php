                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/iibfexam_update') }}" id="formAccountSettings"
                            ...
                            <div class="mb-3 col-md-6">
                                @if (Auth::user()->id != $apply_user_id)
                                    @if ($services->signature != '')
                                        ...
                                        <br><a target="_blank" href="{{ URL::to('/') }}/upload/services/signature/{{ $services->signature }}"
                                        class="btn btn-primary me-2">View</a><br>
                                    @endif
                                    @else
                                    <label>Signature</label>
                                    <input @if ($services->signature == '') required @endif class="form-control"
                                            ...
                                            @if ($services->signature != '')
                                            <a target="_blank" href="{{ URL::to('/') }}/upload/services/signature/{{ $services->signature }}">Download</a><br>
                                            @endif
                                @endif
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                @if ($services->photo != '')
                                    <label>Photo</label>
                                    <br><a target="_blank" href="{{ URL::to('/') }}/upload/services/photo/{{ $services->photo }}"
                                    class="btn btn-primary me-2">View</a><br>
                                @endif
                                @else
                                <label>Photo</label>
                                <input @if ($services->photo == '') required @endif class="form-control"
                                        ...
                                        @if ($services->photo != '')
                                        <a target="_blank" href="{{ URL::to('/') }}/upload/services/photo/{{ $services->photo }}">Download</a><br>
                                        @endif
                            @endif
