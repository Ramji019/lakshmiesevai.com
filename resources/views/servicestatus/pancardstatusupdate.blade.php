                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/pancard_update') }}" id="formAccountSettings" method="POST"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                value="{{ $services->name }}" class="form-control" name="name" placeholder="Name" />

                                <label for="aadhaar_no" class="form-label number">Aadhaar Number</label>
                                <input readonly type="text"
                                maxlength="12" class="form-control number" value="{{ $services->aadhaar_no }}" name="aadhaar_no" placeholder="Aadhaar No" />
                            </div>
                            <div class="mb-3 col-md-6">
                            <label for="name" class="form-label">Pan Number</label>
                                <input readonly required type="text"
                                value="{{ $services->pan_no }}" class="form-control" name="pan_no" placeholder="" />

                                 <label for="name" class="form-label">Date of Birth</label>
                                <input readonly required type="text"
                                value="{{ $services->dob }}" class="form-control" name="pan_no" placeholder="" />
                        </div>
                    @elseif($serviceid == 69 || $serviceid == 70)

                    <div class="row">
                    <div class="mb-3 col-md-6">
                        <label for="mode" class="form-label">Mode</label>
                            <select @if (Auth::user()->id != $apply_user_id && Auth::user()->id != $services->user_id) disabled @endif required name="mode"
                            id="mode" class="form-control">
                            <option value="">Select Mode</option>
                            <option @if ($services->mode == 'EKYC') selected @endif value="EKYC">
                            EKYC (Pan without Signature)</option>
                            <option @if ($services->mode == 'ESIGN') selected @endif value="ESIGN">
                            ESIGN (Pan with Signature and Photo)</option>
                            </select>
                        ...
                        maxlength="10" class="form-control number" value="{{ $services->mobile }}" name="mobile" placeholder="Mobile Number" />
                        ...
                        <label for="aadhaar_no" class="form-label number">Aadhaar Number</label>
                        <input @if (Auth::user()->id != $apply_user_id && Auth::user()->id != $services->user_id) disabled @endif required type="text"
                        maxlength="12" class="form-control number" value="{{ $services->aadhaar_no }}" name="aadhaar_no" placeholder="Aadhaar Number" />
