                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/rapexam_update') }}" id="formAccountSettings"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" value="{{ $services->csc_id_number }}"  class="form-control"
                                        name="csc_id_number" maxlength="20" placeholder="CSC ID Number"/>
                                     </div>
                                     <div class="mb-3 col-md-6">
                                      <label for="csc_password" class="form-label">CSC Password</label>
                                      <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" value="{{ $services->csc_password }}"  class="form-control"
                                ...
                                @endif
                                  ...
                                  <div class="mb-3 col-md-6">
                                    @if (Auth::user()->id != $apply_user_id)
                                        @if ($services->e_aadhaar_pdf != '')
                                            <label for="e_aadhaar_pdf" class="form-label">E-Adhaar Pdf</label>
                                            <br><a target="_blank" href="{{ URL::to('/') }}/upload/services/e_aadhaar_pdf/{{ $services->e_aadhaar_pdf }}"
                                            class="btn btn-primary me-2">View</a><br>
                                        @endif
                                        @else
                                        <label for="e_aadhaar_pdf" class="form-label">E-Adhaar Pdf</label>
                                        <input @if ($services->e_aadhaar_pdf == '') required @endif class="form-control"
                                                type="file" accept="image/jpeg, image/png" name="e_aadhaar_pdf">
                                                @if ($services->e_aadhaar_pdf != '')
                                                <a target="_blank" href="{{ URL::to('/') }}/upload/services/e_aadhaar_pdf/{{ $services->e_aadhaar_pdf }}">Download</a><br>
                                                @endif
                                    @endif
                                </div>
                                  <div class="mb-3 col-md-6">
                                    <label for="e_aadhaar_password" class="form-label">E-Adhaar Password</label>
                                    <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" value="{{ $services->e_aadhaar_password }}"  class="form-control"
                                    name="e_aadhaar_password" maxlength="15" placeholder="E-Adhaar Password"/>
                                 </div>
