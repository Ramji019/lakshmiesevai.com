                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ url('/submit_statusupdate_itr') }}" id="formAccountSettings" method="POST"
                            ...
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="10" class="form-control number" value="{{ $services->mobile }}"
                            name="mobile" placeholder="Mobile Number"/>

                             <label for="mobile" class="form-label number">Aadhaar NO</label>
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="12" class="form-control number" value="{{ $services->aadhaar_no }}"
                            name="aadhaar_no" placeholder="Aadhaar Number"/>

                             <label for="mobile" class="form-label number">Email</label>
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="50" class="form-control" value="{{ $services->email }}"
                                        ...
                                        @endif
                                         ...
                                         @if (Auth::user()->id != $apply_user_id)
                                            @if ($services->bank_passbook != '')
                                                ...
                                                <br><a target="_blank"
                                                    href="{{ URL::to('/') }}/upload/services/bank_passbook/{{ $services->bank_passbook }}"
                                                    class="btn btn-primary me-2">View</a><br>
                                            @endif
                                        @else
                                            <label>Bank Pass Book</label>
                                            ...
                                            @if ($services->bank_passbook != '')
                                                <a target="_blank"
                                                    href="{{ URL::to('/') }}/upload/services/bank_passbook/{{ $services->bank_passbook }}">Download</a><br>
                                            @endif
                                        @endif
