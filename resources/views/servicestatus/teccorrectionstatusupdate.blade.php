                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="30" class="form-control" value="{{ $services->applicant_name }}"
                            ...
                            <input @if (Auth::user()->id != $apply_user_id) disabled @endif required type="text" maxlength="30" class="form-control" value="{{ $services->email }}"
                            name="email" placeholder="Tec Register Mail"/>
