            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <form class="row g-4" onsubmit="return checkpayment(event)"
                                action="{{ url('submitapply_tailorshop') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                <div class="row">
                                    ...
                                    @if ($serviceid == 152)
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <select required id="course_name" name="course_name" class="form-control">
                                                ...
                                                <option value="Tailoring">Tailoring Course</option>
                                            </select>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input required type="text" maxlength="100" class="form-control"
                                                name="postal_area" placeholder="Postal Area" />
