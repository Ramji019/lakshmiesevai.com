            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <form class="row g-4" action="{{ url('savepmkissan') }}" enctype="multipart/form-data"
                                method="post">
                                {{ csrf_field() }}
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        <label for="land_document" class="form-label">Land Document (All Pages)</label>
                                        <input required accept="application/pdf, image/jpeg, image/png" type="file"
                                            class="form-control" name="land_document" />
