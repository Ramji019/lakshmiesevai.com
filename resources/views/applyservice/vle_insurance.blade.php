            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <form class="row g-4" action="{{ url('submitapply_vle_insurance') }}" enctype="multipart/form-data"
                                method="post">
                                @csrf
                               <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                          <label for="aadhaar_card" class="form-label">Adhaar (Front and Back)</label>
